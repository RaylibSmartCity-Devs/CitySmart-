...
https://github.com/user-attachments/assets/5f20f368-c78d-46b2-8cd1-301f946539c0
...
2.  Copy the images/files inside the `assets` folder.
3.  Paste them inside your build folder where the `.exe` is located (e.g. `build/Release/`).
...
4.  **Run the Simulation**
    * **Windows:** Go to `build\Release` and click `CitySmart.exe`
    * **Linux/Mac:** `./CitySmart`
